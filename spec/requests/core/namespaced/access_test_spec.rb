...
RSpec.describe 'Namespaced::AccessTestController' do
  ...
  context 'when using api keys' do
    ...
    context 'when using an invalid api key' do
      it 'can not access action in namespace' do
        get '/namespaced/access_test/some_action', headers: auth_headers.merge({ 'api-key': 'invalid' })
    ...
    context 'when using a valid api key' do
      it 'can access action in namespace' do
        get '/namespaced/access_test/some_action', headers: auth_headers
