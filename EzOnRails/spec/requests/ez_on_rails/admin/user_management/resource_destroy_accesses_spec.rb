...
RSpec.describe 'ez_on_rails/admin/user_management/resource_destroy_accesses', type: :request do
  # users
  ...
  context 'when logged in as admin' do
    ...
    it 'can destroy selections' do
      ...
      expect(response).to redirect_to(ez_on_rails_resource_destroy_accesses_url)
    end
  end
end
