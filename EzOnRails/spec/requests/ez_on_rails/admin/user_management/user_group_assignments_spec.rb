...
RSpec.describe 'ez_on_rails/admin/user_management/user_group_assignments', type: :request do
  # users
  ...
  context 'when logged in as admin' do
    ...
    it 'can destroy selections' do
      ...
      expect(response).to redirect_to(ez_on_rails_user_group_assignments_url)
    end
  end
end
