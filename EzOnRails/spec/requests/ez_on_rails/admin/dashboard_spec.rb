...
# Spec for testing the access for the actions in Admin::DashboardController.
...
RSpec.describe 'ez_on_rails/admin/dashboard', type: :request do
  # users
  ...
  context 'when not logged in' do
    it 'can not get index' do
      get '/ez_on_rails/admin/dashboard'
