...
pin '@hotwired/turbo', to: 'https://ga.jspm.io/npm:@hotwired/turbo@8.0.21/dist/turbo.es2017-esm.js'
pin '@rails/actioncable/src', to: 'https://ga.jspm.io/npm:@rails/actioncable@7.2.201/src/index.js'
pin '@hotwired/turbo-rails', to: 'https://ga.jspm.io/npm:@hotwired/turbo-rails@8.0.21/app/javascript/turbo/index.js'
